...
export const schema = makeExecutableSchema({
    typeDefs: [Query, Mutation, Location, User, Order, Storage, PalletType, Report],
    resolvers: merge(resolvers, locationResolvers, userResolvers, orderResolvers, storageResolvers, palletTypeResolvers, reportResolvers),
})
